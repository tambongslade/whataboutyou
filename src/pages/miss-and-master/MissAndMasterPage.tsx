...
const MissAndMasterPage: React.FC = () => {
  useSEO({
    ...
    description: 'Participez ou votez pour vos candidats préférés au concours Miss & Master WAY 2026. Une compétition unique célébrant la beauté, le talent et l’intelligence au Cameroun.',
    keywords: 'Miss WAY 2026, Master WAY 2026, concours beauté Cameroun, compétition talent, miss master Cameroun, vote en ligne',
