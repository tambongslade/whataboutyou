        ...
        <div className="relative z-30 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className="group flex items-center justify-center bg-white text-gray-800 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-lg min-w-[200px]"
            >
              <div className="w-5 h-5 mr-3 flex-shrink-0">
                <svg className="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
