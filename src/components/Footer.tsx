        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 pt-16 pb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/whataboutyou.officiel237/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/what_about_you.officiel/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-14 h-14 bg-yellow-400 rounded-2xl flex items-center justify-center hover:bg-yellow-500 transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@whataboutyou.officiel237?lang=en"
                target="_blank"
                rel="noopener noreferrer"
                className="w-14 h-14 bg-yellow-400 rounded-2xl flex items-center justify-center hover:bg-yellow-500 transition-colors"
                aria-label="TikTok"
            ...
            {/* Copyright */}
            <p className="text-gray-400 text-sm uppercase tracking-wider" style={{ fontFamily: 'sans-serif' }}>
              &copy; Copyright. All Rights Reserved Solution+ group 2026
            </p>

            {/* Powered By */}
            <div className="flex items-center gap-3">
              <p className="font-nekst text-gray-500 text-xs uppercase tracking-[0.3em]">Powered by</p>
              <img
                src="/IMG_8667.png"
                alt="Solution +"
                className="h-26 w-auto rounded-xl"
              />
            </div>
          </div>
        </div>
